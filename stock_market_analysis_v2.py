...
# =================================================================================================
# MERGE VWAP WITH LATEST DATA -- Added CR on Rohit  Recommendation on new requirement -  21-MAY-26
# ==================================================================================================
...
# =========================================================
# MAIN FILTER CONDITIONS- Rohit requiremet 21-MAY-26
# =========================================================
#
# ✅ CLOSE_PRICE >= VWAP
# ✅ DELIV_PER > 75
# ✅ RSI > 40
# ✅ CPR BREAKOUT (CLOSE_PRICE > TC)
# ✅ VOLUME >= 50,000
#
# =========================================================
...
filtered = rank_df[
    ...
    (rank_df["DELIV_PER"] > 75) &
    (rank_df["RSI"] > 40) &
    (rank_df["CLOSE_PRICE"] > rank_df["TC"]) &
    (rank_df["TTL_TRD_QNTY"] > 50000)
].copy()

# =========================================================
# SMART STRENGTH CALCULATIONS
# =========================================================
...
# =========================================================
# CONVERT SCORE TO WHOLE NUMBER RANK (1-10)
# =========================================================
...
st.subheader("📊 Momentum Scanner: VWAP + Delivery + RSI + Quantity")
...
st.success(
    f"✅ Total Qualified Stocks Found: {len(filtered)}"
)
...
top_picks = filtered[filtered["RANK"] >= 9]
...
with col1:
    st.metric(
        "🔥 Super Buy Stocks",
        len(filtered[filtered["RANK"] >= 9])
    )

with col2:
    st.metric(
        "🟢 Strong Buy Stocks",
        len(filtered[filtered["RANK"] == 8])
    )

with col3:
    st.metric(
        "🟡 Buy Stocks",
        len(filtered[filtered["RANK"] == 7])
    )
...
st.subheader("🏦 FII vs DII Sector Flow ")
